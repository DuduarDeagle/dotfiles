...
let g:coc_global_extensions = ['coc-sh','coc-html','coc-css','@yaegassy/coc-tailwindcss3','coc-tsserver','coc-eslint','@yaegassy/coc-astro','coc-json','coc-pairs','coc-prettier','coc-emmet','coc-snippets']
